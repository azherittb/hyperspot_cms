...
class UserRegistrationPassword extends BrowserTestBase {
  ...
  public function testPasswordResetFormResendActivation() {
    ...
    $this->assertText($edit3['name'] . ' is not recognized as a username or an email address.', 'Password reset form failed correctly.');
    ...
    $this->assertText($edit4['name'] . ' is not recognized as a username or an email address.', 'Password reset form failed correctly.');
  }
